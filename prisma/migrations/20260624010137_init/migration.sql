...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('MENUNGGU_PEMBAYARAN', 'MENUNGGU_KONFIRMASI', 'DIPROSES', 'SIAP_DIAMBIL', 'SELESAI', 'DIBATALKAN');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('MANUAL_TRANSFER', 'COD');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'AWAITING_VERIFICATION', 'VERIFIED', 'REJECTED', 'COD_RECEIVED');
...
-- CreateEnum
CREATE TYPE "DeliveryMethod" AS ENUM ('PICKUP_COD', 'MANUAL_DELIVERY');
...
-- CreateIndex
CREATE INDEX "StoreProfile_status_idx" ON "StoreProfile"("status");
...
-- AddForeignKey
ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_storeId_fkey" FOREIGN KEY ("storeId") REFERENCES "StoreProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
