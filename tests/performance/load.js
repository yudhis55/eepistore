...
export const options = {
  scenarios: {
    bounded_load: {
      ...
      startVUs: 0,
      stages: [
        { duration: __ENV.WARMUP_DURATION || "1m", target: 10 },
        { duration: __ENV.STAGE_DURATION || "2m", target: 10 },
        { duration: __ENV.STAGE_DURATION || "2m", target: 25 },
        { duration: __ENV.STAGE_DURATION || "2m", target: 50 },
